         ...
         <section class="jumbotron bg text-center mb-0">
            <div class="row pt-5 bg-home">
               ...
               <div class="col-sm-12 col-md-6 d-none d-md-none d-lg-block shadow">
                  <div class="container"><img class="w-100 img-home" src="{{ asset('assets/img/dashboard.jpg')}}">
               </div>
            </div>
         </section>
         ...
         <div class="container">
            ...
            <div class="row mt-5 pt-3 mb-5">
               <div class="col-lg-4 text-center">
                  <img class="img-fluid" src="{{ asset('assets/img/features/dashboard.svg')}}" alt="Generic placeholder image" width="120">
                  <h5 class="mt-5 feature-text">Interfaz amigable</h5>
               </div>

               <div class="col-lg-4 text-center">
                  <img class="img-fluid" src="{{ asset('assets/img/features/secure.svg')}}" alt="Generic placeholder image" width="120">
                  <h5 class="mt-5 feature-text">Almacenamiento seguro</h5>
               </div>

               <div class="col-lg-4 text-center">
                  <img class="img-fluid" src="{{ asset('assets/img/features/support.svg')}}" alt="Generic placeholder image" width="120">
